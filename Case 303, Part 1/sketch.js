...
Officer: 2625551
CaseNum: 303-0-46775134-2625551
...
- Make HiddenStoreValue0 equal to 32

Whilst the mouse is moving:
- Make HiddenStoreValue0 equal to 38

When the mouse button is pressed:
- Make HiddenStoreValue0 equal to 28

When any key is pressed:
- Make HiddenStoreValue0 equal to 6

Whilst the mouse is moving:
- Make HiddenStoreValue1 equal to 13

When the mouse button is released:
- Make HiddenStoreValue1 equal to 47

When the mouse button is pressed:
- Make HiddenStoreValue1 equal to 70

Whilst the mouse is being dragged:
- Make HiddenStoreValue1 equal to 28
...
var HiddenStoreValue0;
var HiddenStoreValue1;
...
function mouseMoved()
{
	...
	HiddenStoreValue0 = 38;
	HiddenStoreValue1 = 13;
}

function mouseDragged()
{
	console.log("mouseDragged", mouseX, mouseY);
	HiddenStoreValue1 = 28;
}

function mousePressed()
{
	console.log("mousePressed");
	HiddenStoreValue0 = 28;
	HiddenStoreValue1 = 70;
}

function mouseReleased()
{
	console.log("mouseReleased");
	HiddenStoreValue0 = 32;
	HiddenStoreValue1 = 47;
}
...
function draw()
{
	...
	drawDial(200, HiddenStoreValue0, 41);
	pop();

	//Draw the lever
	push();
	translate(width - 125,256);
	drawLever(HiddenStoreValue1);
	pop();
